...
export const POST: APIRoute = async ({ request }) => {
  try {
    ...
    if (RESEND_API_KEY) {
      const emailBody = [
        `New CLAIM REQUEST on LamarCountyMS.com`,
        '',
      ...
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'LamarCountyMS.com <noreply@contact.lamarcountyms.com>',
          to: ['hello@lamarcountyms.com'],
          subject: `New Claim Request: ${business.title} — LamarCountyMS.com`,
          reply_to: email,
          text: emailBody,
        }),
