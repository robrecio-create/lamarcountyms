export const towns = [
  { name: 'Hattiesburg', slug: 'hattiesburg', businesses: 0 },
  { name: 'Purvis', slug: 'purvis', businesses: 0 },
  { name: 'Sumrall', slug: 'sumrall', businesses: 0 },
  { name: 'Lumberton', slug: 'lumberton', businesses: 0 },
  { name: 'Oak Grove', slug: 'oak-grove', businesses: 0 },
  { name: 'Bellevue', slug: 'bellevue', businesses: 0 },
];
